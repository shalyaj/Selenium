...
public class BaseTest extends CommonFunction {
	...
	@BeforeSuite
	public void AdminPageLogin() throws InterruptedException, AWTException, java.io.IOException
	{
		try{
		...
		driver.manage().timeouts().pageLoadTimeout(300000, TimeUnit.MILLISECONDS);//Increasing the timeout to Selenium Default Value
	}
