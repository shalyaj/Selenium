...
public class PrintMobileScanSheetPage {
	...
	{
		List<WebElement> orderTableDetails = orderDetails.findElements(By.className("span"));
	}
	public void verifyMobileDetails()
	{
		List<WebElement> mobileTableDetails = mobilerDetails.findElements(By.tagName("td"));
	...
	public void verifyAllTwoDeviceBarCode()
	{
		...
		Assert.assertTrue(PageBase.PrintMobileScanSheetPage().secondDeviceBarCode.isDisplayed());
	}
}
