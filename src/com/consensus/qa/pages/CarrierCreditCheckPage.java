...
public class CarrierCreditCheckPage {
	...
	public void populatingCarrierCreditCheckPage(CarrierCreditCheckDetails cccDetails)
	{
		...
		Utilities.dropdownSelect(stateDD, SelectDropMethod.SELECTBYTEXT,cccDetails.getState());
		...
		Utilities.dropdownSelect(monthDD, SelectDropMethod.SELECTBYTEXT,cccDetails.getBirthMonth());
		Utilities.dropdownSelect(dayDD, SelectDropMethod.SELECTBYTEXT,cccDetails.getBirthDate());
		Utilities.dropdownSelect(yearDD, SelectDropMethod.SELECTBYTEXT,cccDetails.getBirthYear());
		...
		{
		case DRIVERLICENCE:
			Utilities.dropdownSelect(idTypeDD, Utilities.SelectDropMethod.SELECTBYINDEX, "1");
			break;
		case USPASSPORT:
			Utilities.dropdownSelect(idTypeDD, Utilities.SelectDropMethod.SELECTBYINDEX, "2");	
			break;
		case STATEID:
			Utilities.dropdownSelect(idTypeDD, Utilities.SelectDropMethod.SELECTBYINDEX, "3");
			break;
		}

		Utilities.dropdownSelect(idStateDD, Utilities.SelectDropMethod.SELECTBYTEXT, cccDetails.getIdTypeState());

		idNumberTextBox.clear();
		idNumberTextBox.sendKeys(cccDetails.getIdNumber()); 
		PageBase.ServiceProviderVerificationPage().SetMonth(idExpirationMonthDD, cccDetails.getMonth().toString());
		Utilities.dropdownSelect(idExpirationYearDD, Utilities.SelectDropMethod.SELECTBYTEXT, cccDetails.getYear());
		Reporter.log("<br> User: "+cccDetails.getFirstName() + " " + cccDetails.getLastName());
	}
