	...
	public void SelectExchangeReason(ExchangeReason exhangeReason)
	{
		switch(exhangeReason)
		{
			case INPOLICYGUESTRETURN :
				Utilities.dropdownSelect(exchangeReasonDropdown, Utilities.SelectDropMethod.SELECTBYINDEX, "1");
				break;
			case WILLNOTPOWERON :
				Utilities.dropdownSelect(exchangeReasonDropdown, Utilities.SelectDropMethod.SELECTBYINDEX, "2");	
				break;
			case OUTSIDEOFPOLICY :
				Utilities.dropdownSelect(exchangeReasonDropdown, Utilities.SelectDropMethod.SELECTBYINDEX, "3");	
				break;
