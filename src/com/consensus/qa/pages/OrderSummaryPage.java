...
public class OrderSummaryPage extends ShipAdminBaseClass{
	...
	/// <summary>
	/// This function will be used to get value of status as string w.r.t. order id.
	...
	{
		Utilities.dropdownSelect(viewDetailsDropdown, Utilities.SelectDropMethod.SELECTBYTEXT, "View POA Extra Infos");
	...
	public void SelectActivationInfo(String orderId)
	{
		...
		Utilities.dropdownSelect(viewDetailsDropdown, Utilities.SelectDropMethod.SELECTBYTEXT, Constants.VIEW_ACTIVATION_INFO);
