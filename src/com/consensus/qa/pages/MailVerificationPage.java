...
public class MailVerificationPage {
    ...
    public void launchGmailInNewTab() throws InterruptedException, AWTException, java.io.IOException
    {
        try{
            BrowserSettings.driver.findElement(By.cssSelector("body")).sendKeys(Keys.CONTROL + "t");
            BrowserSettings.driver.manage().timeouts().pageLoadTimeout(10000, TimeUnit.MILLISECONDS);
            BrowserSettings.driver.navigate().to(BrowserSettings.readConfig("urlGmail"));
            ...
            signInButton.click();
            BrowserSettings.log.append("Successfully launched the Gmail page in new tab <br>\n");
        }
        catch(Exception e){
        }
        BrowserSettings.driver.manage().timeouts().pageLoadTimeout(300000, TimeUnit.MILLISECONDS);//Setting back to default Selenium timeout
    }
